...
class :py:class:`~lensless.ReconstructionAlgorithm`. The four reconstruction
...
-  :py:class:`~lensless.UnrolledADMM`: unrolled ADMM with a non-negativity
    constraint and a total variation (TV) regularizer [1]_.
